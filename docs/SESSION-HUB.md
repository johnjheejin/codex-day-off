...
- Git: 2026-07-11 원격 갱신 확인 결과 `main`과 `origin/main`이 같은 `b301be2`
...
| 디자인 운영 | `019ee1a1-e78e-70e0-bec6-690070b2a3be` — ponytail/open-design 적용 검토 | 프로젝트 로컬 OmD 파일럿 완료 | 파일럿 성공 기준을 실제 UI 작업에서 평가 |
...
3. 다음 UI 변경 때 OmD 파일럿의 성공 기준을 평가하고 ADR에 결과를 남긴다.
