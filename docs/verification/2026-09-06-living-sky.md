...
공개 도메인에서도 브라우저 29개를 모두 통과했다. [공개 파일 대조](../../assets/verification/2026-09-06-living-sky/production/integrity.json)와 배포 ID·실제 CI 상태는 [배포 운영 문서](../deployment.md)를 따른다. 기능은 공개됐지만 GitHub 자동 배포 토큰은 사용자 확인 대기 중이다.
