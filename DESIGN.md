...
- Sound is optional and off by default. Collection notes are short, locally synthesized, and limited in polyphony. Pause and hidden-page states stop audio and rendering.
...
- Results show the actual exported image with an option to view the sky at full size. The result background recedes enough to keep text readable.
